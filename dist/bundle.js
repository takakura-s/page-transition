	...
	var App = Backbone.Marionette.Application.extend({
	  ...
	  initialize: function initialize(options) {
	    ...
	    var finished = function finished() {
	      ...
	      _this.panel.show(new Panel.View({
	        template: '#pageFinished'
	      }));
	    };
	
	    // 処理完了のイベント
	    State.instance.on('change:finish', function (model, value) {
	      if (value) {
	    ...
	    // 表示するページが変更される時のイベント
	    State.instance.on('change:pageNo', function (model, value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(3), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5), __webpack_require__(4), __webpack_require__(7), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelView = Backbone.Marionette.ItemView.extend({
	  ui: {
	    prev: '.prev',
	    next: '.next',
	    finish: '#finish'
	  ...
	  events: function events() {
	    return {
	      "click @ui.prev": function clickUiPrev(e) {
	        e.preventDefault();
	        window.history.back();
	      },
	      "click @ui.next": function clickUiNext(e) {
	        State.instance.set('clickNext', true);
	      },
	      "click @ui.finish": function clickUiFinish() {
